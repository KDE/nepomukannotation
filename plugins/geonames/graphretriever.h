...
// CAUTION: This is a copy of kdebase/runtime/nepomuk/services/ontology/graphretriever.h
//          Please always update both in parallel until this class is moved into a lib
